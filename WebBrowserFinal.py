...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.add_new_tab(QUrl('http://www.ya.ru'), 'Homepage')
    ...
    def navigate_mozarella(self):
        self.tabs.currentWidget().setUrl(QUrl("https://github.com/timoxayt/TimoxaRepository"))
    ...
    def save_file(self):
        ...
        if filename:
            html = self.tabs.currentWidget().page().toHtml(self, Callable[[str], None])
